...
public class percolation {
    ...
    private find wqfGrid;
    private find wqfFull;
    ...
    public percolation(int n) {
        ...
        wqfGrid = new find(gridSquared + 2); // includes virtual top bottom
        wqfFull = new find(gridSquared + 1); // includes virtual top
    ...
    public boolean isFull(int row, int col) {
        validateSite(row, col);
        return wqfFull.connection(virtualTop, flattenGrid(row, col) - 1);
    }
    ...
    public boolean percolates() {
        return wqfGrid.connection(virtualTop, virtualBottom);
    }
